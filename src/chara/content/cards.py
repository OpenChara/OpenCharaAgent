...
class CharacterCard:
    ...
    def defaults(self) -> dict[str, Any]:
        ...
        Lives in `extensions.chara` (SillyTavern-compatible free-form field):
        ...
        `extensions.chara.polaris` (a string). The normalized value is exposed
    ...
    def theme_colors(self) -> dict[str, str]:
        ...
        Lives in `extensions.chara.theme = {"primary": "#RRGGBB",
    ...
    def avatar_file(self) -> str:
        ...
        `extensions.chara.avatar_file` holds its name. Traversal-bearing
    ...
    # declared under extensions.chara.assets. Resolution is traversal-safe and
    ...
    def asset_options(self, kind: str) -> list[Path]:
        ...
        if not names:
            ...
            if isinstance(sel, str) and sel:
                ...
                # The avatar lives in chara.avatar_file (its own field), not assets.avatar —
    ...
    def user_name_override(self) -> str:
        """The operator's name as the card declares it (extensions.chara.user_name),
    ...
    def render_user_persona(self, user: str = "User") -> str:
        ...
        extensions.chara.user_persona. Stable across a session, so it rides
