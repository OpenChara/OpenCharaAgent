...
OpenCharaAgent divergence (per-chara, one-process-one-chara): the writable root is the
...
logger = logging.getLogger("chara.tools.skills")
...
def skill_matches_platform(frontmatter: Dict[str, Any]) -> bool:
    ...
    = all platforms). OpenCharaAgent is macOS/Linux."""
    import sys
