...
(reference/hermes-agent/tools/delegate_tool.py), RE-SHAPED for OpenCharaAgent's
one-process-one-chara runtime.
  ...
  until all finish. OpenCharaAgent does the SAME: one-process-one-chara does NOT forbid
...
logger = logging.getLogger("chara.tools.delegate_task")
...
# adapted to OpenCharaAgent's tool names. No recursive delegation, no memory writes,
