...
_CARD_DRAFT_SYSTEM = """You draft editable SillyTavern/OpenCharaAgent character-card material from a user's inspiration.
...
_WORLDBOOK_SYSTEM = """You are a world-book author for a SillyTavern/OpenCharaAgent character card.
...
_FIELD_REWRITE_SYSTEM = (
    "You are editing ONE field of a SillyTavern/OpenCharaAgent character card. Rewrite just "
