...
def _discover_characters() -> list[tuple[str, str]]:
    ...
    chara/_bundled/cards, and scanning ROOT left this menu EMPTY."""
...
def _choose_embodiment(settings: Settings) -> None:
    """Imported cards may not know OpenCharaAgent's stance field; ask the operator."""
    from ..content.cards import CharacterCard
...
def run_wizard(non_interactive_ok: bool = True) -> Settings:
    ...
    _say("OpenCharaAgent setup — press Enter to accept the [default] of any question.")
